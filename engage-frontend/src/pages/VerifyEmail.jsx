...
export default function VerifyEmail() {
  ...
  return (
    <>
      <PageSEO
        title="Verify Email | EngageSwap"
        description="Verify your email to secure your EngageSwap account."
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-4">
            <div>
              ...
              <Input
                ...
                placeholder="123456"
                maxLength={6}
                className={`text-center text-2xl tracking-widest ${serverError ? "border-red-500" : ""
                  }`}
                autoComplete="off"
              />
          ...
          <div className="mt-4 text-center">
            <p className="text-sm text-slate-600">
              ...
              <button
                ...
                className={`text-teal-700 hover:underline ${resendLoading || resendCooldown > 0
